...
def test_analysis():
    ...
    assert haspassed == [{'userLogin': 'MananVPatel', 'teams': None, 'languages': [], 'leadership': '0.00', 'uniqueStats': {'commentCount': 0, 'branchesLed': 0, 'filesCreated': 0, 'branches': 0, 'filesLed': 0, 'acceptedLines': 0, 'acceptedCommits': 0, 'codeLines': 0, 'commitCount': 0}, 'contribution': '0.00'}, {'userLogin': 'allisonsteinmetz', 'teams': None, 'languages': [], 'leadership': '0.00', 'uniqueStats': {'commentCount': 0, 'branchesLed': 0, 'filesCreated': 0, 'branches': 0, 'filesLed': 0, 'acceptedLines': 0, 'acceptedCommits': 0, 'codeLines': 0, 'commitCount': 0}, 'contribution': '0.00'}, {'userLogin': 'Juicearific', 'teams': None, 'languages': ['Python'], 'leadership': '10.00', 'uniqueStats': {'commentCount': 0, 'branchesLed': 1, 'filesCreated': 2, 'branches': 0, 'filesLed': 2, 'acceptedLines': 0, 'acceptedCommits': 0, 'codeLines': 32, 'commitCount': 2}, 'contribution': '100.00'}, {'userLogin': '-', 'teams': None, 'languages': '', 'leadership': '10.00', 'uniqueStats': {'commentCount': 0, 'branchesLed': 0, 'filesCreated': 2, 'branches': 0, 'filesLed': 0, 'acceptedLines': 0, 'acceptedCommits': 0, 'codeLines': 32, 'commitCount': 2}, 'contribution': 5.333333333333333}]
